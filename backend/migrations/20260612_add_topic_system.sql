...
('Economics & Finance', 'economics-finance', 'Macroeconomics and traditional finance: stock markets, share prices, inflation, interest rates, employment, recessions, corporate earnings. Example questions: Will the central bank cut rates? Will the stock close higher this quarter?', TRUE, 3),
...
('Crypto', 'crypto', 'Cryptocurrencies and blockchain: bitcoin, ethereum, tokens, exchanges, DeFi, staking, crypto regulation. Example questions: Will the spot ETF be approved? Will a major exchange face enforcement action?', TRUE, 10)

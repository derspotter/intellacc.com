...
export interface InitOutput {
  ...
  readonly mlsclient_accept_staged_welcome: (a: number, b: number, c: number, d: number) => void;
  readonly mlsclient_add_member: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly mlsclient_clear_groups: (a: number) => void;
  readonly mlsclient_clear_pending_commit: (a: number, b: number, c: number, d: number) => void;
  readonly mlsclient_clear_pending_proposals: (a: number, b: number, c: number, d: number) => void;
  readonly mlsclient_commit_pending_proposals: (a: number, b: number, c: number, d: number) => void;
  readonly mlsclient_create_group: (a: number, b: number, c: number, d: number) => void;
  readonly mlsclient_create_group_with_external_senders: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly mlsclient_create_identity: (a: number, b: number, c: number, d: number) => void;
  readonly mlsclient_decrypt_message: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly mlsclient_decrypt_message_with_aad: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly mlsclient_derive_key_argon2id: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly mlsclient_discard_staged_commit: (a: number, b: number, c: number, d: number) => void;
  readonly mlsclient_drain_storage_events: (a: number, b: number) => void;
  readonly mlsclient_encrypt_message: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly mlsclient_export_group_info: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly mlsclient_export_storage_state: (a: number, b: number) => void;
  readonly mlsclient_generate_external_psk: (a: number, b: number, c: number, d: number) => void;
  readonly mlsclient_generate_key_packages: (a: number, b: number, c: number) => void;
  readonly mlsclient_generate_last_resort_key_package: (a: number, b: number) => void;
  readonly mlsclient_get_credential_bytes: (a: number, b: number) => void;
  readonly mlsclient_get_group_confirmation_tag: (a: number, b: number, c: number, d: number) => void;
  readonly mlsclient_get_group_epoch: (a: number, b: number, c: number, d: number) => void;
  readonly mlsclient_get_group_ids: (a: number) => number;
  readonly mlsclient_get_group_member_identities: (a: number, b: number, c: number, d: number) => void;
  readonly mlsclient_get_group_members: (a: number, b: number, c: number, d: number) => void;
  readonly mlsclient_get_identity_fingerprint: (a: number, b: number) => void;
  readonly mlsclient_get_key_package_bundle_bytes: (a: number, b: number) => void;
  readonly mlsclient_get_key_package_bytes: (a: number, b: number) => void;
  readonly mlsclient_get_key_package_lifetime: (a: number, b: number) => void;
  readonly mlsclient_get_own_leaf_index: (a: number, b: number, c: number, d: number) => void;
  readonly mlsclient_get_sent_message: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly mlsclient_get_signature_keypair_bytes: (a: number, b: number) => void;
  readonly mlsclient_get_staged_welcome_info: (a: number, b: number, c: number, d: number) => void;
  readonly mlsclient_has_group: (a: number, b: number, c: number) => number;
  readonly mlsclient_import_granular_events: (a: number, b: number, c: number) => void;
  readonly mlsclient_import_storage_state: (a: number, b: number, c: number, d: number) => void;
  readonly mlsclient_inspect_group_info: (a: number, b: number, c: number, d: number) => void;
  readonly mlsclient_join_by_external_commit: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => void;
  readonly mlsclient_key_package_lifetime_from_bytes: (a: number, b: number, c: number, d: number) => void;
  readonly mlsclient_leave_group: (a: number, b: number, c: number, d: number) => void;
  readonly mlsclient_list_staged_welcomes: (a: number) => number;
  readonly mlsclient_merge_pending_commit: (a: number, b: number, c: number, d: number) => void;
  readonly mlsclient_merge_staged_commit: (a: number, b: number, c: number, d: number) => void;
  readonly mlsclient_new: () => number;
  readonly mlsclient_process_commit: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly mlsclient_process_proposal: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly mlsclient_process_welcome: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly mlsclient_propose_external_psk: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly mlsclient_reboot_group: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => void;
  readonly mlsclient_recover_fork_by_readding: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly mlsclient_regenerate_key_package: (a: number, b: number) => void;
  readonly mlsclient_reject_staged_welcome: (a: number, b: number, c: number, d: number) => void;
  readonly mlsclient_remove_group: (a: number, b: number, c: number, d: number) => void;
  readonly mlsclient_remove_member: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly mlsclient_restore_identity: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => void;
  readonly mlsclient_self_update: (a: number, b: number, c: number, d: number) => void;
  readonly mlsclient_set_group_aad: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly mlsclient_stage_welcome: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly mlsclient_store_external_psk: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly mlsclient_store_sent_message: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => void;
